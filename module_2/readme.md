...
Этапы работы над проектом содержат в себе:
...
Практически все поля содержат пустые значения. В столбце "количество пропущенных занятий" присутствуют выбросы, в столбцах Fedu и famrel тоже имеют место быть нетипичные значения. Однако их мало, что позволяет сделать вывод о том, что данные достаточно чистые.
